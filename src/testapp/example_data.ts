...
export function createVanillaTasks(): Task[] {
    return [
        ...
        createTask2("id2", "id1", "Item 2 long name", new Date("2024-04-15T00:00:00"), new Date("2024-04-18T23:59:00")),
        ...
        createTask2("id5", "id5", "Item 5", new Date("2024-04-01T00:00:00"), new Date("2024-04-03T23:59:00")),
